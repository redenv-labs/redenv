...
updatedAt: '2026-02-06T08:43:15.157Z'
---
...
- [Validation](/docs/sdk/python/secrets-object/validation) — Validate required secrets with `require()`
- [Scoping](/docs/sdk/python/secrets-object/scoping) — Group related secrets by prefix
