---
title: Quickstart
description: Get up and running with Redenv in under 5 minutes. Learn how to create your first project, add secrets, and use them in your application.
---
...
- An [Upstash Redis](https://console.upstash.com) instance (free tier works!)
...
- <span className="text-green-500">✔</span> Encrypted with AES-256-GCM
- <span className="text-green-500">✔</span> Stored in Upstash Redis
- <span className="text-green-500">✔</span> Versioned (version 1)
- <span className="text-green-500">✔</span> Associated with user and timestamp
...
<Tabs items={['JavaScript/TypeScript', 'Python']}>
  <Tab value="JavaScript/TypeScript">
    ...
    **4. Create a Redenv client:**
    ...
    await redenv.init(); // optional: pre-fetches secrets into process.env at startup
    ```
...
- **Stuck?** Check [Troubleshooting](/docs/cli/overview#troubleshooting)
