...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen bg-neutral-950 text-foreground selection:bg-primary/30 flex flex-col overflow-x-hidden">
      ...
      {/* Hero Section */}
      <section className="relative z-10 w-full min-h-screen flex flex-col items-center justify-center md:px-6 py-32">
        <motion.div
          variants={container}
          initial="hidden"
          animate="show"
        ...
        >
          ...
          >
            ...
            Rotate API keys in seconds, not deployments. Powered by Upstash
            Redis.
          </motion.p>
        ...
        {/* Terminal Showcase */}
        <motion.div
          className="w-full  not-md:max-w-5xl mx-auto mt-20 px-4"
